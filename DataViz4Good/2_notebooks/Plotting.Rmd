...
2. Use `avg_wealth_long` and `facet_wrap()` to create a plot that illustrates the development for all three variables with points and lines. To do this, `value` must go on the y-axis and `variables` must be used as the facetting variable. 
