...
<ul>
  <li class="m1"><span>The <mono>+</mono> operator is add <high>additional elements</high> to the plot.</span></li>
  <li class="m1">Not to be confused with the pipe <mono>%>%</mono>.</span></li>
</ul>
...
<ul>
  <li class="m1">Oftentimes, creating the desired plot requires appropriate data wrangling.</span></li>
  <li class="m2"><mono>ggplot</mono> works best with <high>long data formats</high>.</span></li>
</ul>
